    ...
    <div className="container mx-auto py-8">
      ...
      <div className="w-full min-w-full max-w-[100vw] mb-8">
        <div className="bg-gradient-to-r from-green-100 to-blue-100 p-6 rounded-xl shadow-md">
          ...
          <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
            The Grade 2 curriculum builds upon the foundation established in Grade 1, encouraging students to develop
            deeper understanding, critical thinking skills, and greater independence in their learning journey.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <Card className="hover:shadow-xl transition-all duration-300 border-t-4 border-purple-500 hover:-translate-y-1">
          ...
          <CardContent>
            <p className="mb-4">
              The Grade 2 Language Arts curriculum focuses on developing students' abilities in listening, speaking,
              reading, viewing, writing, and representing. Students build upon their foundational literacy skills to
              become more confident and independent communicators.
            </p>
        ...
        <Card className="hover:shadow-xl transition-all duration-300 border-t-4 border-green-500 hover:-translate-y-1">
          ...
          <CardContent>
            <p className="mb-4">
              The Grade 2 Mathematics curriculum develops students' understanding of mathematical concepts, skills, and
              problem-solving strategies. Students explore number sense, operations, patterns, geometry, measurement,
              and data management.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
        ...
        <Card className="hover:shadow-xl transition-all duration-300 border-t-4 border-blue-500 hover:-translate-y-1">
          ...
          <CardContent>
            <p className="mb-4">
              The Grade 2 Social Studies curriculum helps students understand their place in the world and their
              relationships with others. Students explore communities, cultural diversity, geography, and historical
              changes over time.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Grade 2 Curriculum Overview</h2>
        <p className="mb-4 text-gray-700">
          The Grade 2 curriculum is designed to build upon the foundation established in Grade 1. It encourages students
          to develop deeper understanding, critical thinking skills, and greater independence in their learning journey.
          The curriculum is organized around key subject areas, each with specific learning outcomes and expectations.
        </p>
