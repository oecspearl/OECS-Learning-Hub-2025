  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="w-full min-w-full max-w-[100vw] mb-8">
        <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-6 rounded-xl shadow-md">
          ...
          <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
            The Grade 5 Language Arts curriculum represents the culmination of elementary language learning, preparing
            students for middle school with sophisticated communication skills. Students engage in advanced literacy
            practices, critical analysis, and complex writing processes while celebrating Caribbean culture and
            developing global perspectives through diverse texts and authentic learning experiences.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-purple-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Grade 5 students master sophisticated listening and speaking skills for academic and social success. They
              engage in complex discussions, debates, and presentations while developing critical thinking abilities.
              Students explore Caribbean dialects and Standard English, participate in formal speaking opportunities,
              and analyze persuasive techniques in media and advertisements with cultural sensitivity.
            </p>
          </CardContent>
          <div className="p-4 pt-0 mt-auto">
            <Link href="/curriculum/grade5-subjects/language-arts/listening-speaking">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-blue-500 hover:-translate-y-1">
          ...
          <div className="p-4 pt-0 mt-auto">
            <Link href="/curriculum/grade5-subjects/language-arts/reading-viewing">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-green-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Grade 5 students master the complete writing process through sophisticated composition across multiple
          ...
          <div className="p-4 pt-0 mt-auto">
            <Link href="/curriculum/grade5-subjects/language-arts/writing-representing">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Grade 5 Language Arts Overview</h2>
        <p className="mb-4 text-gray-700">
          The Grade 5 Language Arts curriculum serves as the capstone of elementary language education, preparing
          students for the transition to middle school. Built on seven Essential Learning Outcomes (ELOs), the
          curriculum emphasizes critical thinking, cultural appreciation, and advanced communication skills. Students
          engage with authentic Caribbean contexts while developing global perspectives through diverse literature and
          media.
        </p>
      ...
      <div className="mt-8 flex justify-center">
        ...
        >
          <Link href="/curriculum/grade5-subjects/activities/language-arts" className="flex items-center">
