    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Explore engaging activities that help students understand their cultural heritage, geographic environment,
          civic responsibilities, and economic foundations. Choose a strand below to get started!
        </p>
      </div>
