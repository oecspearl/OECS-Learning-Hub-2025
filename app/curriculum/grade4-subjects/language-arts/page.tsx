  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="w-full min-w-full max-w-[100vw] mb-8">
        <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-6 rounded-xl shadow-md">
          ...
          <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto">
            ...
            themselves. The Grade 4 curriculum builds upon foundational concepts and introduces new language skills
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-purple-500 hover:-translate-y-1">
          ...
          <div className="p-4 pt-0 mt-auto">
            <Link href="/curriculum/grade4-subjects/language-arts/listening-speaking">
        ...
        <Card className="flex flex-col hover:shadow-xl transition-all duration-300 border-t-4 border-green-500 hover:-translate-y-1">
          ...
          <CardContent className="flex-grow">
            <p className="mb-4">
              Grade 4 students develop their writing skills through the writing process: planning, drafting, revising,
          ...
          <div className="p-4 pt-0 mt-auto">
            <Link href="/curriculum/grade4-subjects/language-arts/writing-representing">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Grade 4 Language Arts Overview</h2>
        <p className="mb-4 text-gray-700">
          The Grade 4 language arts curriculum is designed to build upon the foundation established in earlier grades.
      ...
      <div className="mt-8 flex justify-center">
        ...
        >
          <Link href="/curriculum/grade4-subjects/activities/language-arts" className="flex items-center">
